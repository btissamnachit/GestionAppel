                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Presences (Monthly)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">295/300 Demi Journées</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Presences (Annual)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">595/600 demi journées</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Taux de presences
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Absence justifiée
                                        </span>
                    <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Absence injustifiée
                                        </span>
                </div>
            </div>
        </div>
...
<script src="${pageContext.request.contextPath}/assets/chart.js/Chart.min.js"></script>
